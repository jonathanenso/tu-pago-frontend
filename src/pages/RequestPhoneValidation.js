...
export default function RequestPhoneValidation() {
    ...
    let request = () => {
        dispatch(userActions.requestPhoneValidation(userShow.id));
    }
                        ...
                        <Grid container spacing={3}>
                            ...
                            <Grid item xs={12}>
                                <Paper className={fixedHeightPaper} style={{display: 'flex', justifyContent: 'center', alignItems: 'center'}}>
                                    ...
                                    <img src={imagenSobre} alt="Logo" style={{width: 186, height: 145}} />
                                    <Typography component="body" style={{backgroundColor: 'white'}}>
                                        Enviar mensaje de texto con el código de verificación al número del perfil
                                    </Typography>
                                    <Typography component="body" style={{backgroundColor: 'white', marginTop: 20}}>
                                    Número de teléfono: {userShow.phone}
                                    </Typography>
                                    {requesting ? (
                                            <Button
                                                onClick={() => { request() }}
