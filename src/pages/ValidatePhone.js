...
export default function ValidatePhone() {
    ...
    const validating = useSelector(state => state.phone.validating);
    const success = useSelector(state => state.phone.validationSuccess);
    ...
    let validate = () => {
        if (code === '') {
            ...
            dispatch(userActions.validatePhone(userShow.id, code));
        }
    }
                            ...
                            <Grid item xs={12}>
                                <Paper className={fixedHeightPaper} style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                                    ...
                                    <Typography component="body" style={{ backgroundColor: 'white' }}>
                                        Por favor ingrese el código de validación enviado por mensaje de texto al número de perfil
                                    </Typography>
